...
function InputForm() {
  ...
  const [displayForm, setDisplayForm] = useState(true); // Ensure form is displayed when navigating to Legal Assistance
  ...
  return (
    <div className="form1 bg-gradient-to-r from-blue-500 to-purple-500 min-h-screen">
      ...
      <div className="">
        ...
        {displayForm ? ( // Render form if displayForm is true
          <form onSubmit={handleSubmit} className="pb-36">
            <Tabs value={activeCategory} className="sm:px-10 px-2 pt-36 ">
              <TabsHeader>
                {category.length > 0 && // Check if categories exist to display submit button
