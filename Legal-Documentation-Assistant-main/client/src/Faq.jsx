        ...
        <div className=" rounded m-2 pt-12 p-10">
          <Accordion open={open === 1}>
            ...
            <AccordionBody className="justify-center flex text-gray-100 text-lg">
              The AI powered chatbot essentially helps user in navigating
              through the website according to the user&apos; requirement. The
              chatbot will also automatically help you find legal help in your
              city by recommending list of laywers in required city.
            </AccordionBody>
          </Accordion>
          <Accordion open={open === 2}>
            ...
            >
              Do I need to be a lawyer to use an AI-powered legal document
              generator?
            </AccordionHeader>
            <AccordionBody className="justify-center flex text-gray-100 text-lg">
              No. LexAI helps anyone with or without legal knowledge, generate
              legal documents.
            </AccordionBody>
          </Accordion>
